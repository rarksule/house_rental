...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <form class="ajax" action="{{ route('tenant.request') }}" method="POST"
...
<input type="hidden" id="maintenanceIndexRoute" value="{{ route('tenant.request') }}">
<input type="hidden" id="getInfoRoute" value="{{ route('tenant.request') }}">
</x-app-layout>
