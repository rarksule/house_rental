...
//         "iyzipay":[{"label":"Url","name":"url","is_show":0},{"label":"Key","name":"key","is_show":1},{"label":"Secret","name":"secret","is_show":1}],
...
//         "bank":[{"label":"Hash","name":"url","is_show":0},{"label":"API Key","name":"key","is_show":0},{"label":"Client Secret","name":"secret","is_show":0}],
//         "cash":[{"label":"Hash","name":"url","is_show":0},{"label":"API Key","name":"key","is_show":0},{"label":"Client Secret","name":"secret","is_show":0}]
//         }';
//     }
// }
...
//         return 0;
//     }
//         return number_format($price, 2) . ' Birr' ;
...
{
    return checkUser(USER_ROLE_ADMIN);
}

function isOwner(): bool
{
    return checkUser(USER_ROLE_OWNER);
}
function isTenant(): bool
{
    return checkUser(USER_ROLE_TENANT);
}
...
{
    $fetchNotification = [];
    // Notification::join('users', 'users.id', '=', 'notifications.sender_id')
    //     ->leftJoin('file_managers', function ($join) {
    //         $join->on('file_managers.origin_id', '=', 'notifications.sender_id')
    //             ->where('file_managers.origin_type', '=', 'App\Models\User');
    //     })
